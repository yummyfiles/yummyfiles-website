...
export default function ProjectChangelogPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Changelog — {project.title} — Yummyfiles</title>
      </Helmet>
      <section className="pt-24 pb-24 md:pt-32 md:pb-32">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <ScrollReveal delay={0.1}>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">Changelog</h1>
            <p className="text-white/50 mb-8 max-w-xl">
              Changelog for {project.title} will be available here. Check back soon.
            </p>
          </ScrollReveal>
        </div>
      </section>
